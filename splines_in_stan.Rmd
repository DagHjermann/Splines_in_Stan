...
Y_spl <- smooth.spline(X, Y, nknots = 3)
lines(Y_spl, col="red",lw=2)
...
#   Exception: variable does not exist; processing stage=data initialization; variable name=num_data; base type=int  (in 'model3f7832c02d7d_fit_basis' at line 2)
# 
